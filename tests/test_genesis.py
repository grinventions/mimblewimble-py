...
class GenesisTest(unittest.TestCase):
    def test_genesis(self):
        genesis = mainnet
        assert hash(genesis) == bytes.fromhex('40adad0aec27797b48840aa9e00472015c21baea118ce7a2ff1a82c0f8f5bf82')
    ...
    def test_floonet(self):
        genesis = floonet
        assert hash(genesis) == bytes.fromhex('edc758c1370d43e1d733f70f58cf187c3be8242830429b1676b89fd91ccf2dab')
