...
def test_age_message_serialization():
    ...
    x25519sk = bytes.fromhex(
        "90ad4d97dd2f7dd5360375f2ad72011489baa8beb84f1109b2bdb79b4183476a"
    )

    ciphertext = payload

    age_secret_key = Bech32Encoder.Encode("age-secret-key-", x25519sk)
...
def test_age_recipient_stanza():
    ...
    decoded_ephemeral_share = base64.b64decode(ephemeral_share)
    assert (
        decoded_ephemeral_share.hex()
        == "17f1f785feb71ebab6307f8ed676969baf8cf35f38bb74bba1e1d0e151e23336"
    )

    decoded_encrypted_file_key = base64.b64decode(encrypted_file_key)
    assert (
        decoded_encrypted_file_key.hex()
        == "a5b51c2cb1dd4f93c69ffa187a20feb6c50ed687b1bab49999256ef0772fee67"
    )

    decoded_header_mac = base64.b64decode(header_mac)
    assert (
        decoded_header_mac.hex()
        == "9ead2126ffdb57790b46ba8a53dc2591ec45d924d90e605fd2195e7acfc7c96c"
    )
    ...
    key_material = crypto_scalarmult(private_key, decoded_ephemeral_share)

    assert (
        key_material.hex()
        == "5ab5690070158a90a7dfefa4639381ff676782cd6fce9c2d50d31f2fed389c77"
    )
    ...
    assert (
        key.hex() == "d008d262cc77afdcf96c0a0363ec9894e1bc840a218a5afb86eacb1c5168ba0a"
    )

    ZERO_NONCE = b"\00" * 12

    decrypted_file_key = ChaCha20Poly1305(key).decrypt(
        ZERO_NONCE, decoded_encrypted_file_key, None
    )
    ...
    assert (
        hkdfval.hex()
        == "e9e4ff52ce1c1c2f7c8d280fc6f869ade9bc005b28c07a36c17ee8839e59527f"
    )

    hmac = HMAC(key=hkdfval, algorithm=hashes.SHA256(), backend=default_backend())
    ...
    assert (
        stream_key.hex()
        == "8d1229aaaf0cdf5e7917ab2a725ff68f3338d76bd2734bc9e63fde486e12cdf9"
    )
    ...
    assert (
        ciphertext
        == b'\xcdw\xb9\x10\xa7\x90>V-\xc3=D\xafwc\xdeo\x08\xefx\xdd\x19\x85DtG\xad\xc8\x88*\x84\xe5Z\x07G\x95\x08\xad\xca\xb8\x81N\x1aJ\xfc\x97z\xa8\xfcR\xd8Y\xa4\x90\xcc[\x05\x989\xb1\x9d\xd1U\xdcsJu\xc7\xc4\xb9\x91\x03\x07\x08C\xd5\xfb>s\x80"\t\x85)\x8c(\x1dL\x9f\xa2\xea\xae\xf2f\xf8~\xfe\xc8\xc8\x14\xdeKD\xd8\x8b2\xd2\xca\xf4\xbdM\xcf\xe8_\x88\x03$=\xe1\x11(5g\xde\x9cF,S\xec0#*.\xa0\xe6H\x0f\x94\x8b\x02\xd1\xd9v\xea\xb8u%Dp\xb4\xb9\x88Jvz\xb9\x07\x1e$\x0f\xf5\x80\xe5\xbc\xe5I\x8b\x9f\xc8\xe1\x04\xec0T\x99\xf1cC\xd5\x90\xb27\x18\x1d\x88\x9d\x85\xea\x07\x11\xc4\x92\x0c\x07\xee\xc5\xb8\x1f\xf2&\xf29\x00R\xd4\xb6\xbfe\x18\xfd\xdd\x1a\x8f\xf0\xc3$\xfc0\xf3\xdc`\xed\xd0\xbd\xaa\xbd\t\x9d\xf1\x93.\xa6\xa6C\x0f\x0b;\x9er~P\xbd\xe1\xd5\xf5\x1f\xda>}\xe5J\x93\xc8\xde\xf4^\x9f\xbd\xbblK\xf3\xe3hP\xef\xdc\xb2\xbd\x05\xf1\x08\x9e\xe0\x96\xaeg\xd9\x1b\xc7\xf2/\xb8\xbe%aY\xdf\xc6T'
    )
    plaintext = b""
...
def test_pyrage_case():
    secret_key = (
        "AGE-SECRET-KEY-16XFRV8AFSREQ6JGZ6JK3JW4X0DRVS9ENUPWRZDDEQ6024LG0GFTQ45M3J4"
    )
...
def test_age_both_ways():
    ...
    age_secret_key = (
        "AGE-SECRET-KEY-1WZWET7A3CSR8YM446MGH2U3FNHTJ6G05856GL5X52X3WNTR9NA7S8W0C5H"
    )
...
def test_case_age_slatepacks():
    ...
    # plaintext = b'This is a test message for age encryption and decryption.'
    age_secret_key = (
        "AGE-SECRET-KEY-1QPRVDN2X7RZ03AZUP3MQL5TWXVMWPVJQNVSZAQ58XHDJE6CL64HSW2XHVP"
    )
