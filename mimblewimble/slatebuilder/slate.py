...
class OptionalFieldStatus:
    ...
    def fromByte(self, value: bytes):
        ...
        return OptionalFieldStatus(
            include_num_parts, include_amt, include_fee, include_feat, include_ttl
        )
...
class OptionalStructStatus:
    def __init__(self, include_coms: bool, include_proof: bool):
    ...
    def fromByte(self, value: bytes):
        ...
        return OptionalStructStatus(include_coms, include_proof)


class SlateSignature:
    def __init__(
        self, excess: PublicKey, nonce: PublicKey, signature=None, partial_opt=None
    ):
        self.excess = excess
        self.nonce = nonce
    ...
    def deserialize(self, serializer):
        ...
        return SlateSignature(excess, nonce, partial_opt=partial_opt)
...
class SlateCommitment:
    def __init__(
        self, features: EOutputFeatures, commitment: Commitment, range_proof=None
    ):
    ...
    def deserialize(self, serializer):
        ...
        return SlateCommitment(features, commitment, range_proof=range_proof)
...
class Slate:
    ...
    def getKernelCommitment(self) -> Commitment:
        p = Pedersen()
        kernel_commitment = p.toCommitment(self.calculateTotalExcess())
        del p
    ...
    def appendInput(self, features: EOutputFeatures, commitment: Commitment):
        slate_commitment = SlateCommitment(features, commitment)
        self.commitments.append(slate_commitment)

    def appendOutput(
        self, features: EOutputFeatures, commitment: Commitment, range_proof: RangeProof
    ):
        slate_commitment = SlateCommitment(features, commitment)
    ...
    def toJSON(self):
        obj = {}
        obj["ver"] = "{0}:{1}".format(str(self.version), str(self.block_version))
