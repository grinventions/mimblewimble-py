...
floonet = FullBlock(
    ...
    TransactionBody(
        ...
        [TransactionOutput(
            EOutputFeatures.COINBASE_OUTPUT, # features
            Commitment(bytes.fromhex('08c12007af16d1ee55fffe92cef808c77e318dae70c3bc70cb6361f49d517f1b68')),
            RangeProof([159, 156, 202, 179, 128, 169, 14, 227, 176, 79, 118, 180, 62, 164, 2, 234, 123, 30,
        ...
        [TransactionKernel(
            ...
            Fee(0, 0),
            0, # lock height
            Commitment(bytes.fromhex('08df2f1d996cee37715d9ac0a0f3b13aae508d1101945acb8044954aee30960be9')),
            Signature([25, 176, 52, 246, 172, 1, 12, 220, 247, 111, 73, 101, 13, 16, 157, 130, 110, 196, 123,
...
mainnet = FullBlock(
    ...
    TransactionBody(
        ...
        [TransactionOutput(
            EOutputFeatures.COINBASE_OUTPUT, # features
            Commitment(bytes.fromhex('08b7e57c448db5ef25aa119dde2312c64d7ff1b890c416c6dda5ec73cbfed2edea')),
            RangeProof([147, 48, 173, 140, 222, 32, 95, 49, 124, 101, 55, 236, 169, 107, 134, 98, 147, 160, 72, 150, 21, 169,
        ...
        [TransactionKernel(
            ...
            Fee(0, 0),
            0, # lock height
            Commitment(bytes.fromhex('096385d86c5cfda718aa0b7295be0adf7e5ac051edfe130593a2a257f09f78a3b1')),
            Signature([80, 208, 41, 171, 28, 224, 250, 121, 60, 192, 213, 232, 111, 199, 111, 105, 18, 22, 54, 165, 107,
